...
(
    ...
    output [31 : 0] ci_master4_dataa,
    output [31 : 0] ci_master4_datab,
    input  [31 : 0] ci_master4_result,
    output [ 7 : 0] ci_master4_n,
    output          ci_master4_readra,
    output          ci_master4_readrb,
    output          ci_master4_writerc,
    output [ 4 : 0] ci_master4_a,
    output [ 4 : 0] ci_master4_b,
    output [ 4 : 0] ci_master4_c,
    output [31 : 0] ci_master4_ipending,
    output          ci_master4_estatus,
    output          ci_master4_clk,   
    output          ci_master4_clken,
    output          ci_master4_reset, 
    output          ci_master4_reset_req,
    output          ci_master4_start,
    input           ci_master4_done,
    ...
    assign  ci_master4_dataa    = ci_slave_dataa;
    assign  ci_master4_datab    = ci_slave_datab;
    assign  ci_master4_n        = ci_slave_n;
    assign  ci_master4_a        = ci_slave_a;
    assign  ci_master4_b        = ci_slave_b;
    assign  ci_master4_c        = ci_slave_c;
    assign  ci_master4_ipending = ci_slave_ipending;
    assign  ci_master4_estatus  = ci_slave_estatus;
    assign  ci_master4_clk      = ci_slave_clk;
    assign  ci_master4_clken    = ci_slave_clken;
    assign  ci_master4_reset_req = ci_slave_reset_req;
    assign  ci_master4_reset    = ci_slave_reset;
    ...
    assign select3 = ci_slave_n >= 4 && ci_slave_n < 5;
    ...
    assign select4 = ci_slave_n >= 0 && ci_slave_n < 1;

    assign ci_master4_readra  = (select4 && ci_slave_readra);
    assign ci_master4_readrb  = (select4 && ci_slave_readrb);
    assign ci_master4_writerc = (select4 && ci_slave_writerc);
    assign ci_master4_start   = (select4 && ci_slave_start);
